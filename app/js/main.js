$(document).ready(function () {
    ...
    if ($('body').find('#caleandar').length > 0) {
        ...
        var events = [
            ...
            // Janeiro
            {'Date': new Date(2019, 0, 1), 'Modificator': 'important', 'Title': 'Dia mundial da paz', 'Month': months[0]},
            ...
            // Março
            {'Date': new Date(2019, 1, 5), 'Modificator': 'important', 'Title': 'Carnaval', 'Month': months[2]},
            ...
            {'Date': new Date(2019, 3, 21), 'Modificator': 'important', 'Title': 'Páscoa', 'Month': months[3]},
            {'Date': new Date(2019, 3, 24), 'Modificator': 'star', 'Title': 'Dia mundial da meningite', 'Month': months[3]},

            //Maio
            {'Date': new Date(2019, 4, 1), 'Modificator': 'important', 'Title': 'Dia do Trabalho/ Campanha Gripe', 'Month': months[4]},
            {'Date': new Date(2019, 4, 8), 'Modificator': 'important', 'Title': 'Dia Internacional da Cruz Vermelha', 'Month': months[4]},
            {'Date': new Date(2019, 4, 12), 'Modificator': 'important', 'Title': 'Dia da Enfermagem/ Dia das Mães', 'Month': months[4]},
            ...
            // Agosto
            {'Date': new Date(2019, 7, 1), 'Modificator': 'important', 'Title': 'Campanha de catapora', 'Month': months[7]},
            ...
            {'Date': new Date(2019, 8, 23), 'Modificator': 'important', 'Title': 'Início da Primavera', 'Month': months[8]},
            ...
            // Outubro
            {'Date': new Date(2019, 9, 1), 'Modificator': 'important', 'Title': 'Dia do Idoso', 'Month': months[9]},
            ...
            {'Date': new Date(2019, 9, 12), 'Modificator': 'important', 'Title': 'Dia das Crianças', 'Month': months[9]},
            ...
            // Novembro
            {'Date': new Date(2019, 10, 5), 'Modificator': 'important', 'Title': 'Dia Nacional de Controle da Dengue (dia D)', 'Month': months[10]},
            ...
            {'Date': new Date(2019, 11, 25), 'Modificator': 'important', 'Title': 'Natal', 'Month': months[11]},
            {'Date': new Date(2019, 11, 31), 'Modificator': 'important', 'Title': 'Réveillon', 'Month': months[11]},
        ];
        var settings = {};
